...
class CreateProcess extends StatefulWidget {
  CreateProcess({Key? key}) : super(key: key);
                    ...
                    children: [
                      Row(
                        children: [
                          SizedBox(
                            width: size.width * .15,
                            child: textField(
                                'NProcesso', Icon(Icons.person, color: primary),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: textField(
                                'Nome Juiz', Icon(Icons.person, color: primary),
                                ...
                                child: ButtonTheme(
                                  ...
                                  child: Padding(
                                    ...
                                    child: DropdownButton(
                                      ...
                                      value: tipoProcesso,
                                      items: tiposProcesso.map((String items) {
