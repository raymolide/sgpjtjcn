...
class Utilizador extends StatefulWidget {
  String codigo;
  Utilizador({Key? key, required this.codigo}) : super(key: key);

  @override
  State<Utilizador> createState() => _UtilizadorState();
}

class _UtilizadorState extends State<Utilizador> {
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (snapshot.connectionState == ConnectionState.waiting ||
                        ...
                        if (snapshot.data!.isNotEmpty) {
                          ...
                          pessoas.sort(((a, b) => int.parse(a.codigo)
                              .compareTo(int.parse(b.codigo))));
