            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Expanded(
                    child: textField(
                        'Cod Advogado', Icon(Icons.person, color: primary),
                        controller: controllerdataNascimento),
                  ),
                  SizedBox(width: size.width * .01),
                  Expanded(
                    child: textField(
                        'Nome Advogado', Icon(Icons.person, color: primary),
                        controller: controllerGenero),
                  ),
                ],
              ),
                ...
                children: [
                  Expanded(
                    child: textFieldFormParecer(
                        'Queixa', Icon(Icons.person, color: primary),
                        controller: controllerGenero, linhas: 3),
                  ),
                ],
              ),
              SizedBox(height: size.height * .02),
